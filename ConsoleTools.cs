...
namespace LightNovelSnifferCore_CLI
{
    internal class ConsoleTools : IInput, IOutput
    {
        ...
        {
            string input =
                AskInformation(question + " " + LightNovelSnifferCore_CLI_Strings.AskQuestionChoicesPositiveAnswer.ToUpper() +
                               "/" + LightNovelSnifferCore_CLI_Strings.AskQuestionChoicesNegativeAnswer.ToLower());
            return input != null &&
                   !input.ToUpper().Equals(LightNovelSnifferCore_CLI_Strings.AskQuestionChoicesNegativeAnswer.ToUpper());
        }
        ...
        {
            string input =
                AskInformation(question + " " + LightNovelSnifferCore_CLI_Strings.AskQuestionChoicesPositiveAnswer.ToLower() +
                               "/" + LightNovelSnifferCore_CLI_Strings.AskQuestionChoicesNegativeAnswer.ToUpper());
            return
